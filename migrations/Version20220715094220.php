 ...
 */
final class Version20220715094220 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE author ADD birth_date DATE DEFAULT NULL, ADD death_date DATE DEFAULT NULL');
